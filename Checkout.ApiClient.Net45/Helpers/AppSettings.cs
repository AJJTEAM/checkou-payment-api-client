...
namespace Checkout
{
    ...
    public sealed class AppSettings
    {
        ...
        public static string ShoppingListUserName
        {
            get { return _userName ?? (_userName = ReadConfig("ShoppingList.UserName", true)); }
            set { _userName = value; }
        }

        public static string ShoppingListPassword
        {
            get { return _password ?? (_password = ReadConfig("ShoppingList.Password", true)); }
            set { _password = value; }
        }
