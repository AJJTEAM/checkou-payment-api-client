namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _shoppingListTokenUri;
        private static string _shoppingListGetUri;
        private static string _shoppingListGetByProductNameUri;
        private static string _updateShoppingItemUri;
        private static string _deleteShoppingItemUri;
        private static string _createShoppingItemUri;
        public static void ResetApiUrls()
        {
            ...
            _shoppingListTokenUri = null;
            _shoppingListGetUri = null;
            _shoppingListGetByProductNameUri = null;
            _updateShoppingItemUri = null;
            _deleteShoppingItemUri = null;
            _createShoppingItemUri = null;
        }
        ...
        public static string ShoppingListToken
          => _shoppingListTokenUri ?? (_shoppingListTokenUri = string.Concat(AppSettings.BaseApiUri, "/token/shoppingList"));

        public static string ShoppingListGet   
           => _shoppingListGetUri ?? (_shoppingListGetUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList/get"));

        public static string ShoppingListGetByProductName
          => _shoppingListGetByProductNameUri ?? (_shoppingListGetByProductNameUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList/getByProductName/{0}"));
        
        public static string UpdateShoppingItem
          => _updateShoppingItemUri ?? (_updateShoppingItemUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList/update"));

        public static string DeleteShoppingItem
          => _deleteShoppingItemUri ?? (_deleteShoppingItemUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList/Remove/{0}"));
        
        public static string CreateShoppingItem
          => _createShoppingItemUri ?? (_createShoppingItemUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList/add"));
    }
}